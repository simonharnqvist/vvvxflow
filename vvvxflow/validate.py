...
from vvvxflow.errors import *
#from vvvxflow.utils import is_correctly_bucketed, count_parquet_files
...
def validate(detection: sql.DataFrame, output_table_name: str, schema_joined_source_detection: StructField, logger: logging.Logger, config: dict):
    try:
